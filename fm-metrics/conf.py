...
# Public endpoint
AMQP_URL = env.get('FM_URL',"amqps://fedora:@rabbitmq.fedoraproject.org/%2Fpublic_pubsub")
...
logger.info(f'Start listening for topics: {TOPICS} on endpoint {AMQP_URL} using UUID {UUID}')
